...
//	while searching for the category in the datababse
...
//	while insert the nutr into the database
	public static final String NUTR_ERROR = "Failed to insert the product nutritions into the database.";
...
//	while insert the quantites as batch into the database
	public static final String QTY_BATCH_ERROR = "Failed to insert the batch quantites into the database.";
