...
public class ProductQuantitiesCategory implements Comparable<ProductQuantitiesCategory> {
    ...
    /**
     * Default constructor for creating an instance of the ProductQuantitiesCategory class.
    ...
    /**
     * Constructor to create an instance of the ProductQuantitiesCategory class with specified values.
     *
     * @param weight The weight or amount of the quantity category.
     * @param unit   The unit of measurement for the quantity category.
     * @param rs     The price of the quantity category.
    ...
    /**
     * Calculate the hash code of the ProductQuantitiesCategory object based on its weight and price.
     *
    ...
    public String toString() {
        return "ProductQuantitiesCategory{" +
                "rs=" + rs +
                ", unit=" + unit +
                ", weight=" + weight +
