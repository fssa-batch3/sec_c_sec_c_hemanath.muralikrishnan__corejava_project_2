...
class TestProductValidator {
  ...
  void testValidateEngNameWithNull() {
    ...
    for (String name : invalidProductNames) {
      try {
        ...
        assertEquals(
          ProductValidatorErrors.INVALID_ENGLISH_NAME_NULL,
          e.getMessage()
        );
      }
    }
  ...
  void testValidateEngNameInvalid() {
    String[] invalidProductNames = {
      "123",
      "@#$%",
      "A!",
      "ProductNameWithNoSpacesButExceedsTheCharacterLimit1234567890",
      "Product Name with 1 number",
      "Product Name with @ symbol",
      "Invalid_product_name_with_underscores",
      "Product-Name-with-dashes",
      "Product Name with an extra long string that exceeds the maximum allowed characters",
      "Product Name with multiple    spaces",
      "Invalid_product_name_with_underscores",
      "Product-Name-with-dashes",
      "Product\tName\tWith\tTabs",
    };
    ...
    for (String name : invalidProductNames) {
      try {
        ...
        assertEquals(
          ProductValidatorErrors.INVALID_ENGLISH_NAME_PATTERN,
          e.getMessage()
        );
      }
    }
  ...
  void testValidateTamilNameValid() {
    String[] validProductNames = {
      ...
      "செலரி",
      "சீன முட்டைக்கோஸ்",
      "நாட்டு வெள்ளரிக்காய்",
      "பச்சை லீட்டஸ் கீரை",
      "லீக்ஸ்",
      "ஐஸ்பெர்க் லீட்டஸ் கீ",
      "சிவப்பு கோஸ்",
      "சிவப்பு லீட்டஸ் கீரை",
      "டர்னிப்",
      "மஞ்சள் குடைமிளகாய்",
      "சீமை சுரைக்காய்",
      "சீமை சுரைக்காய்",
      ...
      "தேங்காய்",
      "காலிஃபிளவர்",
      "சாம்பார் வெள்ளரிக்கா",
      "ஆக்ரா உருளைக்கிழங்கு",
      "பீர்க்கங்காய்",
      "இனிப்பு சோளம்",
      "நாட்டு தக்காளி",
      "அகத்தி கீரை",
  ...
  void testValidateTamilNameWithNull() {
    try {
      ...
      assertEquals(
        ProductValidatorErrors.INVALID_TAMIL_NAME_NULL,
        e.getMessage()
      );
    }
  }
  ...
  void testValidateTamilNameInvalid() {
    ...
    try {
      ...
      assertEquals(
        ProductValidatorErrors.INVALID_TAMIL_NAME_PATTERN,
        e.getMessage()
      );
    }
  }
  ...
  void testImageUrlWithNullInputs() {
    ...
    for (String url : invalidImageUrls) {
      try {
        ...
        assertEquals(
          ProductValidatorErrors.INVALID_IMAGE_URL_NULL,
          e.getMessage()
        );
      }
    }
  ...
  void testImageUrlWithInvalid() {
    String[] invalidImageUrls = {
      "http://example.com/image",
      "https://example.com/image.",
      "ftp://example.com/image.pdf",
      "htp://example.com/image.jpg",
      "http:/example.com/image.jpg",
      "http://example.com/image.png?param=value",
      "https://example.com/image;param=value",
      "file:///C:/path/to/image.jpg",
      "https://example.com/image.mp3",
      "ftp://example.com/image_png",
    };
    ...
    for (String url : invalidImageUrls) {
      try {
        ...
        assertEquals(
          ProductValidatorErrors.INVALID_IMAGE_URL_PATTERN,
          e.getMessage()
        );
      }
    }
  ...
  void testValidateDescWithNullInputs() {
    ...
    for (String desc : invalidDescriptions) {
      try {
        ...
        assertEquals(
          ProductValidatorErrors.INVALID_DESCRIPTION_NULL,
          e.getMessage()
        );
      }
    }
  ...
  void testValidateDescWithInvalid() {
    ...
    for (String desc : invalidDescriptions) {
      try {
        ...
        assertEquals(
          ProductValidatorErrors.INVALID_DESCRIPTION_PATTERN,
          e.getMessage()
        );
      }
    }
  ...
  void testValidateCarboNutrMin() {
    ...
    try {
      ...
      assertEquals(
        ProductValidatorErrors.INVALID_CARBOHYDRATES_NUTR,
        e.getMessage()
      );
    }
  }
  ...
  void testValidateKcalNutrMin() {
    ...
    try {
      ...
      assertEquals(
        ProductValidatorErrors.INVALID_CALORIES_NUTR,
        e.getMessage()
      );
    }
  }
  ...
  void testValidateAvailObjWithNull() {
    ...
    try {
      ...
      assertEquals(
        ProductValidatorErrors.INVALID_AVAILABLE_STOCK_OBJ,
        e.getMessage()
      );
    }
  }
  ...
  void testValidateAvailObj() {
    ...
    ProductAvailableStock stock2 = new ProductAvailableStock(
      24,
      ProductStockUnits.PKT
    );
  ...
  void testValidateAvailObjMinNum() {
    ProductAvailableStock stock1 = new ProductAvailableStock(
      18,
      ProductStockUnits.KG
    );
    ...
    try {
      ...
      assertEquals(
        ProductValidatorErrors.INVALID_AVAILABLE_STOCK_NUM,
        e.getMessage()
      );
    }
  }
  ...
  void testValidateAvailObjWithNullUnit() {
    ...
    try {
      ...
      assertEquals(
        ProductValidatorErrors.INVALID_AVAILABLE_STOCK_UNIT,
        e.getMessage()
      );
    }
  }
  ...
  void testValidateAvailObjWithDecForNos() {
    ...
    try {
      ...
      assertEquals(
        ProductValidatorErrors.INVALID_AVAILABLE_STOCK_PKT_NOS,
        e.getMessage()
      );
    }
  }
  ...
  void testValidateQtyObjWithNull() {
    ...
    try {
      ...
      assertEquals(
        ProductValidatorErrors.INVALID_QUANTITY_CATE_OBJ,
        e.getMessage()
      );
    }
  ...
  void testValidateQtyCateWithNull() {
    ...
    try {
      ...
      assertEquals(
        ProductValidatorErrors.INVALID_QUANTITY_CATE_UNIT,
        e.getMessage()
      );
    }
  }
  ...
  void testValidateQtyCateRsLesser() {
    ...
    try {
      ...
      assertEquals(
        ProductValidatorErrors.INVALID_QUANTITY_CATE_AMOUNT,
        e.getMessage()
      );
    }
  }
  ...
  void testValidateQtyObjWithInvalidKg() {
    ...
    try {
      ...
      assertEquals(
        ProductValidatorErrors.INVALID_QUANTITY_FOR_KG,
        e.getMessage()
      );
    }
  }
  ...
  void testValidateQtyObjWithInvalidPkt() {
    ...
    try {
      ...
      assertEquals(
        ProductValidatorErrors.INVALID_QUANTITY_FOR_PKT,
        e.getMessage()
      );
    }
  }
  ...
  void testValidateQtyObjWithInvalidNos() {
    ...
    try {
      ...
      assertEquals(
        ProductValidatorErrors.INVALID_QUANTITY_FOR_NOS,
        e.getMessage()
      );
    }
  }
  ...
  void testValidateQtyObjWithMinKg() {
    ...
    try {
      ...
      assertEquals(
        ProductValidatorErrors.INVALID_QUANTITY_WEIGHT,
        e.getMessage()
      );
    }
  }
  ...
  void testValidateQtyObjWithDecNOS() {
    ...
    try {
      ...
      assertEquals(
        ProductValidatorErrors.INVALID_QUANTITY_WEIGTH_PKT_NOS,
        e.getMessage()
      );
    }
  }
