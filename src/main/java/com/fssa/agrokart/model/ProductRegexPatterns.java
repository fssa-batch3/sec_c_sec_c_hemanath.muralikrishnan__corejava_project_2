...
public final class ProductRegexPatterns {
	 ...
	 * <p>
	 * Explanation: ^ - Start of the string. (?!.*\\s{2,}) - Negative lookahead to
	 * ensure no consecutive spaces. [A-Za-z ] - Allow letters (both uppercase and
	 * lowercase) and spaces. {2,50} - Minimum of 2 and maximum of 50 characters. $
	 * - End of the string.
	 */
	 ...
	 * <p>
	 * Explanation: ^(?!\\s) - Start of the string and ensure it's not a space.
	 ...
	 * <p>
	 * Explanation: (?i) - Case-insensitive matching. \\b - Word boundary.
	 * ((https?|ftp)://)? - Optional http/https/ftp protocol. [a-z0-9-]+ -
	 * Alphanumeric characters and hyphens. (\\.[a-z0-9-]+)+ - One or more
	 * occurrences of dot and alphanumeric. ([/?].*)? - Optional slash and anything
	 * afterwards. \\.(jpg|jpeg|gif|png|bmp)\\b - File extensions: jpg, jpeg, gif,
	 * png, bmp.
	 */
	 ...
	 * <p>
	 * Explanation: ^ - Start of the string. [\u0020-\u007E\n\r] - Allow printable
	 ...
	 * {@code ProductRegexPatterns} class.
	 */
