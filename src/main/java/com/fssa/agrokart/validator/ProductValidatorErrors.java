...
//	INVALID IMAGE URL checks with regex pattern
	public static final String INVALID_IMAGE_URL = "given image url doesn't match the requested format.";

//	INVALID PRODUCT DESCRIPTION 
	public static final String INVALID_DESCRIPTION = "given description doesn't match the requested format.";
