 ...
 * This class provides methods to validate strings for empty, null values, and
 * regex patterns.
 *
...
public class StringUtil {
	...
	/**
	 * Trim the input string and check if it is empty or null. If the input is null
	 * or becomes empty after trimming, this method returns null. Otherwise, the
	 * trimmed input string is returned for further processing.
	 *
